...
class BackpackTest < MiniTest::Test
  ...
  def test_that_packs_gym_shoes_on_monday_and_thursday
  ...
  def test_that_doesnt_pack_gym_shoes_on_all_other_days
...
- gym shoes
- packed lunch"
    assert_equal(backpack.display_packing_list, expected)
  end
